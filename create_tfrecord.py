"""
Author: kwotsin
Source: https://github.com/kwotsin/create_tfrecords
"""
...
flags.DEFINE_string('dataset_dir', os.path.join(cwd, 'dataset_photos'), 'String: Your dataset directory')
...
flags.DEFINE_string('tfrecord_filename', 'genres', 'String: The output filename to name your TFRecord file')
